...
/**
 * @Author yangtianfu
 * @Date 2023/8/11 13:18
 * @Describe 操作类，在这里实现具体逻辑
 */
public class AccessService extends BaseService {
    private static final String TAG = "AccessService";
//    private static String appPackageName = "com.iflytek.inputmethod.miui";
    private static String appPackageName = "com.miui.calculator";
    // 控制在未处理完逻辑前不要进入逻辑空间
...
//        super.onAccessibilityEvent(accessibilityEvent);
        ...
        Log.d(TAG, "ytf, packageName" + packageName);
//        if (!packageName.equals(appPackageName)) {
//            // 如果活动APP不是目标APP则不响应
//            return;
//        }
        int eventType = event.getEventType();
        Log.d(TAG,"ytf, eventType" + eventType);
        switch (eventType) {
            // 捕获窗口内容改变事件
    ...
    protected void onServiceConnected() {
        ...
        Log.d(TAG, "ytf, onServiceConnected: ");
    }
}
